...
<head>
    ...
    <!-- Simple bar CSS -->
    <link rel="stylesheet" href="layouts/css/simplebar.css">
    <!-- Fonts CSS -->
    <link
        href="https://fonts.googleapis.com/css2?family=Overpass:ital,wght@0,100;0,200;0,300;0,400;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,600;1,700;1,800;1,900&display=swap"
        rel="stylesheet">
    <!-- Icons CSS -->
    <link rel="stylesheet" href="layouts/css/feather.css">
    <!-- Date Range Picker CSS -->
    <link rel="stylesheet" href="layouts/css/daterangepicker.css">
    <!-- App CSS -->
    <link rel="stylesheet" href="layouts/css/app-light.css" id="lightTheme">
    <link rel="stylesheet" href="layouts/css/app-dark.css" id="darkTheme" disabled>
</head>
...
<body>
    <div class="wrapper vh-100">
        <div class="row align-items-center h-100">
            <form method="POST" action="handlers\handelRegister.php" class="col-lg-6 col-md-8 col-10 mx-auto">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password_confirm" class="form-control" id="inputPassword6">
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <button class="btn btn-lg btn-primary btn-block" value="register" type="submit">Sign up</button>
    ...
    <script src="layouts/js/simplebar.min.js"></script>
    <script src='js/daterangepicker.js'></script>
    <script src='js/jquery.stickOnScroll.js'></script>
    <script src="layouts/js/tinycolor-min.js"></script>
    <script src="layouts/js/config.js"></script>
    <script src="layouts/js/apps.js"></script>
